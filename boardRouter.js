...
router.get('/info.html/:id', (req, res) => {
    ...
    let reviews = new Map();
    reviews = boardService.getResenias(req.params.id);
...
router.post('/info.html/:id/saved-review', (req, res) => {
    let cuadro = boardService.getCuadro(req.params.id);
    let review= {
        user: req.params.user,
        date: req.params.reviewDate,
        rating: req.params.reviewRating,
        text: req.params.reviewText
    }
